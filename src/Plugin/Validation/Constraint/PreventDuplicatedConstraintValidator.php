...
use Drupal\Core\Entity\groupInvitationLoaderInterface;
...
class PreventDuplicatedConstraintValidator extends ConstraintValidator implements ContainerInjectionInterface {
  ...
  public static function create(ContainerInterface $container) {
    return new static(
      ...
      $container->get('ginvite.inviation_loader')
    );
  }
  ...
  public function validate($entity, Constraint $constraint) {
    ...
    if (!($entity instanceof GroupContentInterface) || strpos($entity->bundle(), 'group_invitation') === FALSE) {
      return;
    }
